...
public class RangeTest {
    ...
    public void testExpand_LowerGreaterThanUpper() {
    	Range xxpand = Range.expand(new Range(5, 10), 0.6, 0.6);
    	assertEquals("5 should be 7.5", 7.5, xxpand.getLowerBound(), 0.00000001d);
    	assertEquals("10 should be 7.5", 7.5, xxpand.getUpperBound(), 0.00000001d);
    }
    ...
    public void testIntersectsRange() {
    	new Range(1, 5).intersects(new Range(2, 7));
    }
